...
echo "# bioconductor_learn" >> README.md
  ...
  git remote add origin https://github.com/tianxiongfang/bioconductor_learn.git
...
wsx@wsx-ubuntu:~/桌面/Bioconductor_learn$ git remote add origin https://github.com/tianxiongfang/bioconductor_learn.git

wsx@wsx-ubuntu:~/桌面/Bioconductor_learn$ git push -u origin masterUsername for 'https://github.com': tianxiongfang
Password for 'https://tianxiongfang@github.com': 
对象计数中: 3, 完成.
写入对象中: 100% (3/3), 243 bytes | 0 bytes/s, 完成.
Total 3 (delta 0), reused 0 (delta 0)
To https://github.com/tianxiongfang/bioconductor_learn.git
...
文档Github地址：<https://github.com/tianxiongfang/Git-Hankbook>